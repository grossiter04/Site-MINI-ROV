...
import { MapPin, Mail, Globe, Send, BookOpen, CheckCircle, AlertCircle } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-stretch">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-slate-200 p-6 rounded-lg flex gap-5 shadow-sm">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-900 mb-2 uppercase tracking-wider">{t('contato.canais.emailTitle')}</h3>
                <p className="text-slate-600 text-sm leading-relaxed mb-3">
                  {t('contato.canais.emailDesc')}
                </p>
                <a href="mailto:ffc@cesar.school" className="inline-flex items-center gap-1 text-orange-600 text-sm font-bold hover:text-orange-700 hover:underline">
                  ffc@cesar.school
                </a>
              </div>
            </div>

            <div className="bg-white border border-slate-200 p-6 rounded-lg flex gap-5 shadow-sm hover:border-slate-300 hover:shadow-md transition-all">
              <div className="w-12 h-12 bg-slate-50 text-slate-600 rounded flex items-center justify-center flex-shrink-0">
          ...
          <div className="bg-white border border-slate-200 p-8 rounded-lg shadow-sm h-full">

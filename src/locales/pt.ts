export const pt = {
  ...
  home: {
    ...
    comunicacoesDesc: "Apresentações de trabalhos submetidos a revisão por pares e atividades acadêmicas do grupo.",
    anaisTitle: "Anais de Conferências (Proceedings)",
    seminariosTitle: "Seminários de Pesquisa e Palestras Convidadas"
  },
  pesquisa: {
  ...
  publicacoes: {
    title: "Produção Científica e Bibliográfica",
    desc: "Listagem cronológica de publicações produzidas pelo grupo, submetidas e aprovadas em fóruns científicos com revisão por pares.",
  ...
  contato: {
    ...
    form: {
      ...
      assuntoOptions: {
        ...
        opt3: "Interesse em Programas de Pós-Graduação",
  ...
  footer: {
    desc: "Somos um grupo de pesquisa dedicado a explorar as fronteiras da tecnologia e inovação. Nosso foco é pesquisar soluções práticas e impactantes para os desafios atuais, combinando ciência, engenharia e criatividade.",
